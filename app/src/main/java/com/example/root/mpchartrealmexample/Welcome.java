...
public class Welcome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dummy_button.setOnClickListener(nextClick);
    }

    final android.view.View.OnClickListener nextClick = new android.view.View.OnClickListener(){

        @Override
        public void onClick(View v) {
            Log.d("Click", "Hello motto");
